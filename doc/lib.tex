...
nonassociative conjugacy closed loops\index{conjugacy closed loop} of order
$p^2$. Cs\accent127org\H{o} and Dr\'apal \cite{CsDr} described these 3 loops by
multiplicative formulas on $\Z_{p^2}$ and $\Z_p \times \Z_p$.
